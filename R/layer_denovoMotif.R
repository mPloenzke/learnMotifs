...
#' @param lambda_Z_offset L1 penalty for activations centered around 0.5.
#'
...
layer_deNovo <- function (object,
                          ...
                          activity_regularizer = Z_regularizer,
  ...
  lambda_Z_offset <<- lambda_Z_offset
  ...
  keras::create_layer(keras:::keras$layers$Conv2D, object, list(filters = as.integer(filters),
                                                 ...
                                                 bias_regularizer = keras::regularizer_l1(l=lambda_offset), activity_regularizer = activity_regularizer,
