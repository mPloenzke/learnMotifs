...
system(paste('uniprobe2meme ',paste(opt$epochs,"PPM_filters.txt",sep="/"),' > ',paste(opt$epochs,'PPM_meme_format.txt',sep='/'),sep=''))
fl <- 'PPM_meme_format.txt'
system(paste('tomtom -oc ',paste(opt$epochs,'/tomtom_out ',sep=''),'-thresh ',opt$motif_qval_threshold,' ',paste(epoch_dir,fl,sep='/'),opt$JASPAR,sep=''))
```
